...
puts "la tribu verte a #{tribu_verte.credits} clefs avant seed booking"
...
# Booking.create!(
  ...
  puts "la tribu verte a #{tribu_verte.credits} clefs (expected: 250-10 = 240)"
...
Booking.create!(
  arrival: arrival = Date.new(2022, 1, 1),
  departure: departure = Date.new(2022, 1, 15),
  total_price: (departure - arrival) * chaumiere.daily_price,
  status: :pending,
  house: chaumiere,
  user: michel
...
puts "la tribu verte a #{tribu_verte.credits} clefs (expected: 240 - 75 = 165)"
